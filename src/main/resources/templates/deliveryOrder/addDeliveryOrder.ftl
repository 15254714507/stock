...
<div id="add_administrator_style" class="add_menber">
    <form action="" method="post" id="form-DeliveryOrder-add">
        <div class="form-group">
            <label class="form-label"><span class="c-red">*</span>说明：</label>
            <div class="formControls">
                <input type="text" class="input-text" value="正常出货" id="description"
                       name="description"
...
<script type="text/javascript" src="script/deliveryOrder/addDeliveryOrder.js"></script>
</body>
</html>