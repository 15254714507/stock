...
<div id="add_administrator_style" class="add_menber">
    <form action="" method="post" id="form-provider-add">
        ...
        <div class="form-group">
            ...
            <div class="formControls">
                <input type="text" name="company" autocomplete="off" value=""
...
<script type="text/javascript" src="script/provider/addProvider.js"></script>
</body>
</html>