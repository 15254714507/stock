    ...
    <div id="system_style">
        <div class="search_style" style="margin-bottom:0;margin-top: 0">
            <ul class="search_content clearfix">
                ...
                <!--订单的编码-->
                <li><input id="start" type="hidden" value="${(purchaseOrder.getCode())!}"/></li>
                <li>
                ...
                <#if purchaseOrder.status ==false>
                    <li>
                        <a href="javascript:void(0)" id="purchase_order_drug_add" class="btn btn-warning"><i
                                    class="fa fa-plus"></i>
                            添加入库药品</a>
                    </li>
                </#if>
        ...
        <!--订单上的表格-->
        <div id="purchaseOrderDrugTableIframe" style="height: 500px;margin-top: 0" class="Columns_style margin">
        </div>
    </div>
</div>
<script type="text/javascript" src="script/purchaseOrderDrug/purchaseOrderDrugList.js"></script>
</body>
</html>