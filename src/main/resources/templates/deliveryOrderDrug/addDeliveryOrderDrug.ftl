...
<div id="add_administrator_style" class="add_menber">
    <form action="" method="post" id="form-deliveryOrderDrug-add">
        <input style="display: none" name="code" value="${(deliveryOrderCode)!}"/>
...
<script type="text/javascript" src="script/deliveryOrderDrug/addDeliveryOrderDrug.js"></script>
</body>
</html>