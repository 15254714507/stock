    ...
    <div id="system_style">
        <div class="search_style" style="margin-top: 0">
            <ul class="search_content clearfix">
                ...
                <li>
                    <a href="javascript:void(0)" id="purchase_order_add" class="btn btn-warning"><i class="fa fa-plus"></i>
                        添加入库单</a>
                </li>
            </ul>
        </div>
        <!--入库单表格-->
        <div id="purchaseOrderTableIframe" style="height: 500px;margin-top: 0" class="Columns_style margin">
        </div>
    </div>
</div>
<script type="text/javascript" src="script/purchaseOrder/purchaseOrderList.js"></script>
</body>
</html>