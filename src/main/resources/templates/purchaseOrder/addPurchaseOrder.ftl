...
<div id="add_administrator_style" class="add_menber">
    <form action="" method="post" id="form-purchaseOrder-add">
        <div class="form-group">
            <label class="form-label"><span class="c-red">*</span>说明：</label>
            <div class="formControls">
                <input type="text" class="input-text" value="正常补货" id="description"
                       name="description"
...
<script type="text/javascript" src="script/purchaseOrder/addPurchaseOrder.js"></script>
</body>
</html>