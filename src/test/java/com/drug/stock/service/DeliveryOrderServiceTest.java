...
public class DeliveryOrderServiceTest {
    ...
    public void getDeliveryOrderTest() {
        ...
        Assert.assertTrue(num.intValue() > 0);
        deliveryOrder = deliveryOrderService.getDeliveryOrderByCode(code);
        deliveryOrder = deliveryOrderService.getDeliveryOrder(deliveryOrder.getId());
        Assert.assertNotNull(deliveryOrder);
    }
    ...
    public void updateDeliveryOrderTest() throws InterruptedException {
        ...
        DeliveryOrder deliverOrder1 = deliveryOrderService.getDeliveryOrderByCode(deliveryOrder.getCode());
    ...
    public void deleteDeliveryOrderTest() {
        ...
        Assert.assertTrue(num.intValue() > 0);
        deliveryOrder = deliveryOrderService.getDeliveryOrderByCode(code);
        num = deliveryOrderService.deleteDeliveryOrder(deliveryOrder.getId());
